...
//	}
	...
	public TransferUI() {
		...
		final JLabel lblWrongAccountNo = new JLabel("");
		...
		btnTransfer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(bank.validateAccount(acNo)){
					...
					if(amount1 >= currentAc.getBalance()){
						lblWrongAccountNo.setText("Amount Not Enough");
						lblWrongAccountNo.setVisible(true);
					}
					else{
					currentAc.transfer(Transferac, amount1);
					lblWrongAccountNo.setText("Amount Transfered");
					lblWrongAccountNo.setForeground(Color.BLUE);
					lblWrongAccountNo.setVisible(true);
					textField.setText("");
					textField_1.setText("");
					}
					...
					textField.setText("");
					textField_1.setText("");
					lblWrongAccountNo.setText("Wrong Account No");
					lblWrongAccountNo.setVisible(true);
				}
			}
		});
